...
<head>
    ...
    <style>
        :root {
            ...
            --muted: #5e7780;
            --accent: #0b766f;
            --accent-strong: #085f59;
            --border: rgba(23, 50, 62, 0.14);
            --shadow: 0 20px 44px rgba(10, 35, 45, 0.11);
            --chip: #eff9f7;
        }
        ...
        * {
        ...
        body {
            ...
            background:
                ...
                radial-gradient(circle at 100% 5%, rgba(242, 186, 103, 0.18), transparent 32%),
                linear-gradient(160deg, #f6fbf8 0%, var(--bg) 62%, #ecf3ef 100%);
            padding: 24px;
        }
        ...
        .head {
            ...
            padding: 20px 22px;
            color: #eef9f8;
            background: linear-gradient(140deg, #0c405b 0%, #0b766f 100%);
        }
        ...
        .empty {
            border: 1px dashed rgba(23, 50, 62, 0.24);
            border-radius: 14px;
            padding: 28px;
            text-align: center;
            color: var(--muted);
        ...
        .invoice-link {
            ...
            box-shadow: 0 10px 18px rgba(11, 118, 111, 0.22);
        }
        ...
        .receipt-link {
            ...
            color: #0b5f58;
            background: #e9f7f5;
            border: 1px solid rgba(11, 118, 111, 0.25);
        }
        ...
        .ship {
            margin-top: 10px;
            padding-top: 10px;
            border-top: 1px dashed rgba(23, 50, 62, 0.22);
        }
...
<body>
    <main class="shell" role="main">
        <header class="head">
            ...
            <div class="actions">
                <a class="btn" href="<?php echo site_url('user'); ?>">Back to Catalog</a>
                <a class="btn" href="<?php echo site_url('logout'); ?>">Logout</a>
            </div>
        </header>
